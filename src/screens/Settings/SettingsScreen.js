...
const styles = StyleSheet.create({
  ...
  sectionLbl: { fontSize: 12, fontWeight: '700', color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 8, marginTop: 4, marginLeft: 2 },
  avatarWrap: { alignItems: 'center', marginBottom: 24, marginTop: 8 },
  avatar: { width: 72, height: 72, borderRadius: 36, backgroundColor: Colors.purple, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  avatarName: { fontSize: 18, fontWeight: '800', color: Colors.text },
  avatarEmail: { fontSize: 13, color: Colors.textSecondary, fontWeight: '600', marginTop: 2 },
  subRow: { flexDirection: 'row', alignItems: 'center', padding: 14, borderRadius: 14, marginBottom: 6, borderWidth: 1.5 },

  // Paywall
  paywallWrap: { flex: 1, backgroundColor: '#fff', paddingHorizontal: 20 },
  ...
  paywallTitle: { fontSize: 28, fontWeight: '900', color: Colors.text, letterSpacing: -0.8 },
  paywallSub: { fontSize: 15, color: Colors.textSecondary, fontWeight: '600', marginTop: 4 },
  featureList: { backgroundColor: Colors.bg, borderRadius: 16, padding: 16, gap: 2 },
  featureRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: Colors.border },
  planBtn: { backgroundColor: Colors.purple, borderRadius: 100, paddingVertical: 18, alignItems: 'center' },
  planBtnTxt: { color: '#fff', fontSize: 17, fontWeight: '800' },
  legalTxt: { fontSize: 12, color: Colors.textSecondary, textAlign: 'center', marginTop: 14, lineHeight: 18 },
});
