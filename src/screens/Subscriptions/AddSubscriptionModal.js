...
const styles = StyleSheet.create({
  ...
  quickChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 100, borderWidth: 1.5, borderColor: Colors.border, backgroundColor: '#fff', marginRight: 8 },
  quickTxt: { fontSize: 13, fontWeight: '600', color: Colors.text },
  cycleRow: { flexDirection: 'row', gap: 8, marginBottom: 16 },
  cycleBtn: { flex: 1, paddingVertical: 10, borderRadius: 10, borderWidth: 1.5, borderColor: Colors.border, alignItems: 'center', backgroundColor: '#fff' },
  cycleBtnActive: { backgroundColor: Colors.purple, borderColor: Colors.purple },
  cycleTxt: { fontSize: 12, fontWeight: '700', color: Colors.textSecondary },
  cycleTxtActive: { color: '#fff' },
  leapNotice: { backgroundColor: Colors.amberLight, borderRadius: 10, padding: 12, marginBottom: 16, marginTop: -8 },
  trialNotice: { backgroundColor: Colors.greenLight, borderRadius: 10, padding: 12, marginBottom: 16, marginTop: -8 },
  catWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  catChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 100, borderWidth: 1.5, borderColor: Colors.border, backgroundColor: '#fff' },
  catTxt: { fontSize: 12, fontWeight: '700', color: Colors.text },
});
