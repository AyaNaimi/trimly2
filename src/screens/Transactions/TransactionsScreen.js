...
const styles = StyleSheet.create({
  ...
  periodRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, marginTop: 12 },
  periodNav: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  periodLabel: { fontSize: 15, fontWeight: '700', color: Colors.text },
  pillToggle: { flexDirection: 'row', backgroundColor: Colors.white, borderRadius: 100, padding: 4, borderWidth: 1.5, borderColor: Colors.border },
  ...
  chartCard: { backgroundColor: Colors.white, borderRadius: 16, padding: 18, marginBottom: 14, borderWidth: 1.5, borderColor: Colors.border, flexDirection: 'row' },
  chartBars: { flex: 1, flexDirection: 'row', alignItems: 'flex-end', height: 120, gap: 5 },
  barCol: { flex: 1, alignItems: 'center', gap: 6 },
  barTrack: { flex: 1, width: '85%', justifyContent: 'flex-end' },
  barFill: { backgroundColor: Colors.purple, borderRadius: 6, width: '100%' },
  barLbl: { fontSize: 11, color: Colors.textSecondary, fontWeight: '600' },
  yAxis: { justifyContent: 'space-between', height: 120, marginLeft: 10 },
  yLbl: { fontSize: 10, color: Colors.textTertiary },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 16, padding: 16, marginBottom: 14, borderWidth: 1.5, borderColor: Colors.border },
  totalLbl: { fontSize: 14, fontWeight: '700', color: Colors.textSecondary },
  totalAmt: { fontSize: 18, fontWeight: '700', color: Colors.red },
  dateSep: { fontSize: 12, fontWeight: '700', color: Colors.textSecondary, textTransform: 'capitalize', marginTop: 14, marginBottom: 8, marginLeft: 2 },
  txRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1.5, borderColor: Colors.border },
  txIcon: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center' },
  txName: { fontSize: 14, fontWeight: '700', color: Colors.text },
  txCat: { fontSize: 12, color: Colors.textTertiary, fontWeight: '600', marginTop: 2 },
  txAmt: { fontSize: 16, fontWeight: '700', color: Colors.red },
